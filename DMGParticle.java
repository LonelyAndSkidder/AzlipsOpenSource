...
import cn.Azlips.api.events.misc.EventLivingUpdate;
import cn.Azlips.api.events.misc.EventUpdate;
import cn.Azlips.api.events.rendering.EventRender3D;
import cn.Azlips.api.events.world.EventPostUpdate;
import cn.Azlips.module.Module;
import cn.Azlips.module.ModuleType;
import cn.Azlips.ui.particle.Location;
import cn.Azlips.ui.particle.Particles;
...
public class DMGParticle extends Module{
    ...
    public DMGParticle() {
	super("DMGParticle", new String[] {}, ModuleType.Render,"伤害显示");
    }
